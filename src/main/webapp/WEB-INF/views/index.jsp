			...
			<div class="allmenu">전체메뉴
				<div class="allmenu_con">
					...
					<dl style="width:15.666%;">
						...
						<dd><a href="javascript:;" onclick="clickMenu('portfolio3', '방명록', '/portfolio/qna/index.do', false)">방명록(준비중)</a></dd>
					</dl>
				</div>
			</div>
				...
				<dl>
					...
					<dd class="gnb_submenu">
						<ul>	
							...
							<li id="portfolio3_submenu" onclick="clickMenu('portfolio3', '방명록', '/portfolio/qna/index.do', false)">방명록(준비중)</li>
						</ul>
					</dd>
				</dl>
			</div>
